 ...
 */
public class DynamicDetailView3 extends LinearLayout {


    Context ctx;
    MainActivity activity;

    public DynamicDetailView3(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.ctx = context;
    ...
    protected void onFinishInflate() {
        ...
        this.findViewById(R.id.btn_forward).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                View detail = activity.getLayoutInflater().inflate(R.layout.dynamic_user_detail4, null);
